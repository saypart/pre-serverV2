...
public class ContentController {
    ...
    public ResponseEntity patchContent(@PathVariable("content-id") long contentId,@RequestParam long nowMemberId,
...
//        if(nowMemberId != memberId){return new ResponseEntity(HttpStatus.BAD_REQUEST);}
    ...
    public ResponseEntity deleteContent(@PathVariable("content-id") long contentId,@RequestParam long nowMemberId){
